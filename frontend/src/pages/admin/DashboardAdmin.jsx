...
import { 
  ...
  ChefHat, ArrowRight, Activity, Calendar, CheckCircle2 
} from 'lucide-react';
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-gradient-to-br from-emerald-600 to-emerald-800 rounded-2xl p-5 text-white shadow-lg shadow-emerald-600/20">
